...
return ( 
    <div className="p-3 max-w-lg mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <input type="text" defaultValue={currentUser.username} id="username"  className="border p-3 rounded-lg"onChange={handleChange} placeholder="username"/>
            <input type="text" defaultValue={currentUser.email} id="email"  className="border p-3 rounded-lg"onChange={handleChange} placeholder="email"/>
